...
//SRC: Har brukt en del (mye) kode fra Eivind. https://github.com/EwyBoy/SQL-Test/blob/master/src/database/DatabaseManager.java
//Har også jobbet mye sammen med Eivind og David.
public class DatabaseManagingSystem {
    ...
    public static void createTable(Database db, String data) {
